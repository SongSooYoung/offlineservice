...
// 레벨업 UI에서 무기를 선택해 레벨을 올릴 때마다
// 무기를 활성화 시켜주고 싶다. SetActive 
public class LightningLvUpGroup : MonoBehaviour
{
    ...
    int count;
    public GameObject LightningLevelUpWindow;
    ...
    {
        {
            ...
            else if (count == 4)
            {
                ...
                LightningLevelUpWindow.SetActive(false);
